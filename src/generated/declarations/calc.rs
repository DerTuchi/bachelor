 ...
 *==========================================================================*/
/*
 * \file /home/dertuchi/TSL/generated_tsl/generator_output/include/generated/declarations/calc.rs
 * \date 2024-05-06
...
pub struct mask_add<const Idof: bool, T: TargetExtension>(pub PhantomData<T>);
