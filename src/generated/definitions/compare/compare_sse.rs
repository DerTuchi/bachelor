 ...
 *==========================================================================*/
/*
 * \file /home/dertuchi/work/TSL/generated_tsl/generator_output/include/generated/definitions/compare/compare_sse.rs
 * \date 2024-04-28
...
impl< const Idof: bool > SimdPrimitiveImpl for less_than<Idof, sse<i32>> {
    ...
    fn apply(args: Self::Args) -> Self::ReturnType{
        ...
        unsafe{_mm_cmplt_epi32(vec_a, vec_b)}
    }
...
impl< const Idof: bool > SimdPrimitiveImpl for less_than<Idof, sse<f32>> {
    ...
    fn apply(args: Self::Args) -> Self::ReturnType{
        let _ = Self::check;
        let (vec_a, vec_b) = args;
        unsafe{_mm_cmplt_ps(vec_a, vec_b)}
    }
...
impl< const Idof: bool > SimdPrimitiveImpl for less_than<Idof, sse<f64>> {
    ...
    fn apply(args: Self::Args) -> Self::ReturnType{
        let _ = Self::check;
        let (vec_a, vec_b) = args;
        unsafe{_mm_cmplt_pd(vec_a, vec_b)}
    }
...
impl< const Idof: bool > SimdPrimitiveImpl for less_than<Idof, sse<i64>> {
    ...
    fn apply(args: Self::Args) -> Self::ReturnType{
        let _ = Self::check;
        let (vec_a, vec_b) = args;
        unsafe{_mm_cmpgt_epi64(vec_b, vec_a)}
    }
